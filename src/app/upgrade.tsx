...
const styles = StyleSheet.create({
  ...
  price: { color: '#B98418', fontSize: 43, lineHeight: 50, fontWeight: '700' },
  ...
  primary: { position: 'relative', minHeight: 68, marginTop: 28, borderRadius: 8, backgroundColor: '#C68A0F', alignItems: 'center', justifyContent: 'center' },
