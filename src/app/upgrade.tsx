...
const styles = StyleSheet.create({
  ...
  strengthHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 9 }, strengthRule: { flex: 1, height: 1, backgroundColor: '#DFD2BE' }, strengthHeadingCopy: { alignItems: 'center' }, strengthTitle: { color: '#96692C', fontSize: 14, lineHeight: 18, fontWeight: '700' }, strengthSubtitle: { marginTop: 1, color: '#7B746A', fontSize: 8, lineHeight: 11 }, benefitGrid: { marginTop: 5, borderWidth: 1, borderColor: colors.line, borderRadius: 9, overflow: 'hidden', backgroundColor: 'rgba(255,255,255,0.28)' }, benefit: { minHeight: 45, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 9, paddingVertical: 4, gap: 8, borderBottomWidth: 1, borderBottomColor: '#E8DFD2' }, benefitLast: { borderBottomWidth: 0 }, benefitIcon: { width: 24, height: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.charcoal }, benefitIconText: { color: '#E4B94E', fontSize: 11, lineHeight: 14 }, benefitCopy: { flex: 1, minWidth: 0 }, benefitTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 6 }, benefitTitle: { color: '#B17A28', fontSize: 11, lineHeight: 14, fontWeight: '700' }, benefitTitleRule: { flex: 1, height: 1, backgroundColor: '#E8DFD2' }, benefitBody: { marginTop: 1, color: '#3E3A34', fontSize: 9, lineHeight: 13 },
