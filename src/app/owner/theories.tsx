...
const styles = StyleSheet.create({ screen: { padding: spacing.lg, gap: spacing.md }, header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: spacing.md }, title: { fontSize: 30, marginVertical: 6 }, message: { color: colors.gold }, layout: { flexDirection: 'row', gap: spacing.lg, minHeight: 560 }, list: { width: 300, borderRightWidth: 1, borderColor: colors.line }, row: { padding: spacing.md, borderBottomWidth: 1, borderColor: colors.line }, selected: { backgroundColor: colors.paper }, id: { color: colors.muted, fontSize: 11 }, editor: { flex: 1, maxWidth: 720, gap: spacing.md }, field: { gap: 6 }, input: { borderWidth: 1, borderColor: colors.line, borderRadius: 6, padding: 10, minHeight: 42, backgroundColor: colors.white }, multi: { minHeight: 140, textAlignVertical: 'top' }, categorySelector: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, categoryOption: { minHeight: 40, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.line, borderRadius: 8, backgroundColor: colors.white }, categoryOptionActive: { borderColor: colors.gold, backgroundColor: colors.gold }, categoryOptionText: { color: colors.inkSoft, fontSize: 12, fontWeight: '700' }, categoryOptionTextActive: { color: colors.white }, actions: { flexDirection: 'row', gap: spacing.md, flexWrap: 'wrap' } });
