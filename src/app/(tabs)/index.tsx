      ...
      {!isPaid ? (
        ...
        >
          <View style={styles.unlockCopy}>
            ...
            <AppText style={styles.unlockBody}>{catalogTechniqueCards.length}の処世術・{catalogTheories.length}の理論・全{COMPLETE_LEARNING_CASE_COUNT}ケースを30日間</AppText>
          </View>
...
const styles = StyleSheet.create({
  ...
  reelArrow: { position: 'absolute', top: '50%', zIndex: 4, width: 48, height: 52, marginTop: -26, alignItems: 'center', justifyContent: 'center' },
  ...
  shortcutLink: { flex: 1, minWidth: 0, minHeight: 44, paddingHorizontal: 4, alignItems: 'center', justifyContent: 'center' },
  ...
  theoryShortcut: { minWidth: 84, minHeight: 44, paddingHorizontal: 4, alignItems: 'center', justifyContent: 'center' },
  theoryShortcutDesktop: { flex: 1, minWidth: 0, minHeight: 44 },
  theoryShortcutMobile: { flexBasis: '33.333%', minWidth: '33.333%', minHeight: 44 },
