...
const styles = StyleSheet.create({
  ...
  railArrow: { position: 'absolute', top: 76, zIndex: 2, width: 44, height: 44, borderWidth: 1, borderColor: colors.line, borderRadius: 22, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' },
