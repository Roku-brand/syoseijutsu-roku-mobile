...
const styles = StyleSheet.create({
  discoverContent: { maxWidth: 1260, paddingBottom: spacing.xl * 2 },
  ...
  personaRail: { gap: 14, paddingHorizontal: 2, paddingBottom: 3 },
  personaRailDesktop: { paddingHorizontal: 24 },
  railArrow: { position: 'absolute', top: 84, zIndex: 2, width: 44, height: 44, borderWidth: 1, borderColor: colors.line, borderRadius: 22, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' },
