    ...
    <SafeAreaView edges={['top', 'left', 'right']} style={styles.safe}>
      ...
      >
        <View style={styles.topBar}>
          ...
          <View style={styles.menu}><View style={styles.menuLine} /><View style={styles.menuLine} /><View style={styles.menuLine} /></View>
        </View>
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.stats}>
            ...
            <View style={styles.stat}><View style={styles.statLine}><AppText variant="serif" style={styles.statNumber}>526</AppText><AppText variant="serif" style={styles.statLabel}>の理論</AppText></View><AppText style={styles.statSub}>心理学・行動科学・戦略など</AppText></View>
          </View>
        </View>
        ...
        <View style={styles.offer}>
          ...
          <View style={styles.offerBody}>
            ...
            <View style={styles.benefits}>
              {['216の処世術をすべて収録', '526の理論をすべて収録', '買い切り・追加料金なし', 'オフラインでいつでも読める'].map((item) => <AppText key={item} style={styles.benefit}>✓　{item}</AppText>)}
            </View>
          </View>
        ...
        <View style={styles.previewSection}>
          ...
          {previewCard ? <View style={styles.previewCard}>
            <AppText style={styles.previewNumber}>No.{getTechniqueDisplayId(previewCard)}</AppText>
