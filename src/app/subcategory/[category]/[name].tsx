  ...
  return (
    <Screen contentContainerStyle={styles.content}>
      ...
      <View style={styles.titleRow}>
        ...
        <View style={styles.countBadge}><AppText style={styles.countText}>{persona.items.length}の処世術</AppText></View>
      </View>
      <AppText style={styles.description}>相手に安心感を与え、自然と好かれる人になるための処世術です。</AppText>
      ...
      <View style={styles.listCard}>
        {persona.items.map((item, index) => (
          <Pressable
            ...
            style={({ pressed }) => [styles.row, index === persona.items.length - 1 && styles.rowLast, pressed && styles.pressed]}
          >
...
const styles = StyleSheet.create({
  content: { width: '100%', maxWidth: 760, alignSelf: 'center', paddingTop: spacing.lg },
