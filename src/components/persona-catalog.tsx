...
const styles = StyleSheet.create({
  ...
  personaCardRail: { width: 190, flexShrink: 0 },
  personaCardRailCompact: { width: 164, minHeight: 176, paddingHorizontal: 10 },
  personaCardGrid: { flexGrow: 1, flexBasis: 184, maxWidth: 242 },
  personaCardGridCompact: { flexBasis: '46%', maxWidth: '48%', minHeight: 184, paddingHorizontal: 9 },
