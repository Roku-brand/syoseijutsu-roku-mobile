...
const styles = StyleSheet.create({
  ...
  primary: { width: '100%', maxWidth: 360, minHeight: 52, marginTop: 24, borderRadius: 8, backgroundColor: colors.charcoal, alignItems: 'center', justifyContent: 'center' },
  primaryText: { color: colors.goldLight, fontWeight: '700' },
  secondary: { width: '100%', maxWidth: 360, minHeight: 48, marginTop: 10, borderWidth: 1, borderColor: colors.gold, borderRadius: 8, alignItems: 'center', justifyContent: 'center' },
